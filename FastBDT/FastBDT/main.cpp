...
int train() {
    ...
    std::string datafile("/Users/lidong/pythonNoteBook/FastBDT/iris.txt");
    std::string weightfile("/Users/lidong/pythonNoteBook/FastBDT/weightfile.txt");
    ...
    std::cout<<"feature binnings"<<std::endl;
     ...
     */
    std::cout<<"event samplle"<<std::endl;
     ...
     */
    std::cout<<" output weightfile "<<std::endl;
